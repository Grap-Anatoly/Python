...
from KerasFuzzy.layers.fuzzy_layer import FuzzyLayer
from KerasFuzzy.layers.defuzzy_layer import DefuzzyLayer
...
y_train = np.array( [([1,0,0,0] if a[0]<10 and a[1]<10 else
                    ...
                    [0,0,1,0] if a[0]>10 and a[1]<10 else
...
print(model.predict( np.array([[25, 15]])))
print(model.predict( np.array([[35, 10]])))
